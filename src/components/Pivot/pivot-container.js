...
class PivotContainer extends React.Component {
  ...
  render(){
    ...
    const datasetMonths = metadata.getDatasetMonthsNew(value.drawingData);
    ...
    // const hasAnimation = customer === 'master';
    ...
    const markers = metadata.getMarkers(value.datapointCol);
            ...
            <div className="control-container-form">
              <div className={"control-container pivot-div"}>
                ...
                <div className={"control select-1 pivot-div"}>
                  <Select value={controls.datapoint} axes={axes} />
                  <Select value={controls.xAxis} axes={axes} />
                  <Select value={controls.yAxis} axes={axes} />
                </div>
                <div className={"control select-2 pivot-div"}>
                  <Select value={controls.radiusAxis} axes={axes} />
                  <Select value={controls.colorAxis} axes={axes} />
