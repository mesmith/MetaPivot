...
const utils = function () {
  ...
  // Return the difference of estimate and actual
  //
  function getEstimateDiff(rec, estimate, actual) {
    const est = isNumeric(rec[estimate]) ? rec[estimate] : 0;
    const act = isNumeric(rec[actual]) ? rec[actual] : 0;
    return est - act;
  }
